...
object TermuxConstants {
    ...
    const val PERMISSION_RUN_COMMAND = "$TERMUX_PACKAGE_NAME.permission.RUN_COMMAND" // Default: "com.termux.permission.RUN_COMMAND"
    ...
    const val TERMUX_FILE_SHARE_URI_AUTHORITY = "$TERMUX_PACKAGE_NAME.files" // Default: "com.termux.files"
    ...
    class TERMUX_APP {
        companion object {
            ...
            const val TERMUX_AM_SOCKET_FILE_PATH = "$APPS_DIR_PATH/termux-am/am.sock" // Default: "/data/data/com.termux/files/apps/com.termux/termux-am/am.sock"
            ...
            const val FILE_SHARE_RECEIVER_ACTIVITY_CLASS_NAME = "$TERMUX_PACKAGE_NAME.app.api.file.FileShareReceiverActivity" // Default: "com.termux.app.api.file.FileShareReceiverActivity"

            /** Termux app FileViewReceiverActivity class name */
            const val FILE_VIEW_RECEIVER_ACTIVITY_CLASS_NAME = "$TERMUX_PACKAGE_NAME.app.api.file.FileViewReceiverActivity" // Default: "com.termux.app.api.file.FileViewReceiverActivity"

            /** Termux app core activity name. */
            const val TERMUX_ACTIVITY_NAME = "$TERMUX_PACKAGE_NAME.app.TermuxActivity" // Default: "com.termux.app.TermuxActivity"

            /** Termux app settings activity name. */
            const val TERMUX_SETTINGS_ACTIVITY_NAME = "$TERMUX_PACKAGE_NAME.app.activities.SettingsActivity" // Default: "com.termux.app.activities.SettingsActivity"

            /** Termux app core service name. */
            const val TERMUX_SERVICE_NAME = "$TERMUX_PACKAGE_NAME.app.TermuxService" // Default: "com.termux.app.TermuxService"

            /** Termux app run command service name. */
            const val RUN_COMMAND_SERVICE_NAME = "$TERMUX_PACKAGE_NAME.app.RunCommandService" // Termux app service to receive commands from 3rd party apps "com.termux.app.RunCommandService"
        }
        ...
        class TERMUX_ACTIVITY {
            companion object {
                ...
                const val EXTRA_FAILSAFE_SESSION = "$TERMUX_PACKAGE_NAME.app.failsafe_session" // Default: "com.termux.app.failsafe_session"

                /** Intent action to make termux app notify user that a crash happened. */
                const val ACTION_NOTIFY_APP_CRASH = "$TERMUX_PACKAGE_NAME.app.notify_app_crash" // Default: "com.termux.app.notify_app_crash"

                /** Intent action to make termux reload its termux session styling */
                const val ACTION_RELOAD_STYLE = "$TERMUX_PACKAGE_NAME.app.reload_style" // Default: "com.termux.app.reload_style"
                ...
                const val EXTRA_RELOAD_STYLE = "$TERMUX_PACKAGE_NAME.app.reload_style" // Default: "com.termux.app.reload_style"

                /**  Intent {@code boolean} extra for whether to recreate activity for the TERMUX_ACTIVITY.ACTION_RELOAD_STYLE intent. */
                const val EXTRA_RECREATE_ACTIVITY = "$TERMUX_ACTIVITY_NAME.EXTRA_RECREATE_ACTIVITY" // Default: "com.termux.app.TermuxActivity.EXTRA_RECREATE_ACTIVITY"

                /** Intent action to make termux request storage permissions */
                const val ACTION_REQUEST_PERMISSIONS = "$TERMUX_PACKAGE_NAME.app.request_storage_permissions" // Default: "com.termux.app.request_storage_permissions"
            }
        }
        ...
        class TERMUX_SERVICE {
            companion object {
                ...
                const val ACTION_STOP_SERVICE = "$TERMUX_PACKAGE_NAME.service_stop" // Default: "com.termux.service_stop"

                /** Intent action to make TERMUX_SERVICE acquire a wakelock */
                const val ACTION_WAKE_LOCK = "$TERMUX_PACKAGE_NAME.service_wake_lock" // Default: "com.termux.service_wake_lock"

                /** Intent action to make TERMUX_SERVICE release wakelock */
                const val ACTION_WAKE_UNLOCK = "$TERMUX_PACKAGE_NAME.service_wake_unlock" // Default: "com.termux.service_wake_unlock"

                /** Intent action to execute command with TERMUX_SERVICE */
                const val ACTION_SERVICE_EXECUTE = "$TERMUX_PACKAGE_NAME.service_execute" // Default: "com.termux.service_execute"

                /** Uri scheme for paths sent via intent to TERMUX_SERVICE */
                const val URI_SCHEME_SERVICE_EXECUTE = "$TERMUX_PACKAGE_NAME.file" // Default: "com.termux.file"
                ...
                const val EXTRA_ARGUMENTS = "$TERMUX_PACKAGE_NAME.execute.arguments" // Default: "com.termux.execute.arguments"
                /** Intent {@code String} extra for stdin of the command for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent */
                const val EXTRA_STDIN = "$TERMUX_PACKAGE_NAME.execute.stdin" // Default: "com.termux.execute.stdin"
                /** Intent {@code String} extra for command current working directory for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent */
                const val EXTRA_WORKDIR = "$TERMUX_PACKAGE_NAME.execute.cwd" // Default: "com.termux.execute.cwd"
                ...
                @Deprecated("Deprecated")
                const val EXTRA_BACKGROUND = "$TERMUX_PACKAGE_NAME.execute.background" // Default: "com.termux.execute.background"
                /** Intent {@code String} extra for command the {@link Runner} for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent */
                const val EXTRA_RUNNER = "$TERMUX_PACKAGE_NAME.execute.runner" // Default: "com.termux.execute.runner"
                ...
                const val EXTRA_BACKGROUND_CUSTOM_LOG_LEVEL = "$TERMUX_PACKAGE_NAME.execute.background_custom_log_level" // Default: "com.termux.execute.background_custom_log_level"
                ...
                const val EXTRA_SESSION_ACTION = "$TERMUX_PACKAGE_NAME.execute.session_action" // Default: "com.termux.execute.session_action"
                /** Intent {@code String} extra for shell name for commands for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent */
                const val EXTRA_SHELL_NAME = "$TERMUX_PACKAGE_NAME.execute.shell_name" // Default: "com.termux.execute.shell_name"
                ...
                const val EXTRA_SHELL_CREATE_MODE = "$TERMUX_PACKAGE_NAME.execute.shell_create_mode" // Default: "com.termux.execute.shell_create_mode"
                /** Intent {@code String} extra for label of the command for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent */
                const val EXTRA_COMMAND_LABEL = "$TERMUX_PACKAGE_NAME.execute.command_label" // Default: "com.termux.execute.command_label"
                /** Intent markdown {@code String} extra for description of the command for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent */
                const val EXTRA_COMMAND_DESCRIPTION = "$TERMUX_PACKAGE_NAME.execute.command_description" // Default: "com.termux.execute.command_description"
                /** Intent markdown {@code String} extra for help of the command for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent */
                const val EXTRA_COMMAND_HELP = "$TERMUX_PACKAGE_NAME.execute.command_help" // Default: "com.termux.execute.command_help"
                ...
                const val EXTRA_PLUGIN_API_HELP = "$TERMUX_PACKAGE_NAME.execute.plugin_api_help" // Default: "com.termux.execute.plugin_help"
                ...
                const val EXTRA_RESULT_DIRECTORY = "$TERMUX_PACKAGE_NAME.execute.result_directory" // Default: "com.termux.execute.result_directory"
                ...
                const val EXTRA_RESULT_SINGLE_FILE = "$TERMUX_PACKAGE_NAME.execute.result_single_file" // Default: "com.termux.execute.result_single_file"
                ...
                const val EXTRA_RESULT_FILE_BASENAME = "$TERMUX_PACKAGE_NAME.execute.result_file_basename" // Default: "com.termux.execute.result_file_basename"
                ...
                const val EXTRA_RESULT_FILE_OUTPUT_FORMAT = "$TERMUX_PACKAGE_NAME.execute.result_file_output_format" // Default: "com.termux.execute.result_file_output_format"
                /** Intent {@code String} extra for the error {@link Formatter} format of the
                 * {@link #EXTRA_RESULT_FILE_BASENAME} result file for the TERMUX_SERVICE.ACTION_SERVICE_EXECUTE intent */
                const val EXTRA_RESULT_FILE_ERROR_FORMAT = "$TERMUX_PACKAGE_NAME.execute.result_file_error_format" // Default: "com.termux.execute.result_file_error_format"
                ...
                const val EXTRA_RESULT_FILES_SUFFIX = "$TERMUX_PACKAGE_NAME.execute.result_files_suffix" // Default: "com.termux.execute.result_files_suffix"
        ...
        class RUN_COMMAND_SERVICE {
            companion object {
                ...
                const val ACTION_RUN_COMMAND = "$TERMUX_PACKAGE_NAME.RUN_COMMAND" // Default: "com.termux.RUN_COMMAND"

                /** Intent {@code String} extra for absolute path of command for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_COMMAND_PATH = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_PATH" // Default: "com.termux.RUN_COMMAND_PATH"
                ...
                const val EXTRA_ARGUMENTS = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_ARGUMENTS" // Default: "com.termux.RUN_COMMAND_ARGUMENTS"
                ...
                const val EXTRA_REPLACE_COMMA_ALTERNATIVE_CHARS_IN_ARGUMENTS = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_REPLACE_COMMA_ALTERNATIVE_CHARS_IN_ARGUMENTS" // Default: "com.termux.RUN_COMMAND_REPLACE_COMMA_ALTERNATIVE_CHARS_IN_ARGUMENTS"
                ...
                const val EXTRA_COMMA_ALTERNATIVE_CHARS_IN_ARGUMENTS = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_COMMA_ALTERNATIVE_CHARS_IN_ARGUMENTS" // Default: "com.termux.RUN_COMMAND_COMMA_ALTERNATIVE_CHARS_IN_ARGUMENTS"

                /** Intent {@code String} extra for stdin of the command for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_STDIN = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_STDIN" // Default: "com.termux.RUN_COMMAND_STDIN"
                /** Intent {@code String} extra for current working directory of command for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_WORKDIR = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_WORKDIR" // Default: "com.termux.RUN_COMMAND_WORKDIR"
                ...
                @Deprecated("Deprecated")
                const val EXTRA_BACKGROUND = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_BACKGROUND" // Default: "com.termux.RUN_COMMAND_BACKGROUND"
                /** Intent {@code String} extra for command the {@link Runner} for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_RUNNER = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_RUNNER" // Default: "com.termux.RUN_COMMAND_RUNNER"
                ...
                const val EXTRA_BACKGROUND_CUSTOM_LOG_LEVEL = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_BACKGROUND_CUSTOM_LOG_LEVEL" // Default: "com.termux.RUN_COMMAND_BACKGROUND_CUSTOM_LOG_LEVEL"
                ...
                const val EXTRA_SESSION_ACTION = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_SESSION_ACTION" // Default: "com.termux.RUN_COMMAND_SESSION_ACTION"
                /** Intent {@code String} extra for shell name of commands for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_SHELL_NAME = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_SHELL_NAME" // Default: "com.termux.RUN_COMMAND_SHELL_NAME"
                ...
                const val EXTRA_SHELL_CREATE_MODE = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_SHELL_CREATE_MODE" // Default: "com.termux.RUN_COMMAND_SHELL_CREATE_MODE"
                /** Intent {@code String} extra for label of the command for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_COMMAND_LABEL = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_COMMAND_LABEL" // Default: "com.termux.RUN_COMMAND_COMMAND_LABEL"
                /** Intent markdown {@code String} extra for description of the command for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_COMMAND_DESCRIPTION = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_COMMAND_DESCRIPTION" // Default: "com.termux.RUN_COMMAND_COMMAND_DESCRIPTION"
                /** Intent markdown {@code String} extra for help of the command for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_COMMAND_HELP = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_COMMAND_HELP" // Default: "com.termux.RUN_COMMAND_COMMAND_HELP"
                ...
                const val EXTRA_PENDING_INTENT = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_PENDING_INTENT" // Default: "com.termux.RUN_COMMAND_PENDING_INTENT"
                ...
                const val EXTRA_RESULT_DIRECTORY = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_RESULT_DIRECTORY" // Default: "com.termux.RUN_COMMAND_RESULT_DIRECTORY"
                /** Intent {@code boolean} extra for whether the result should be written to a single file
                 * or multiple files (err, errmsg, stdout, stderr, exit_code) in
                 * {@link #EXTRA_RESULT_DIRECTORY} for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_RESULT_SINGLE_FILE = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_RESULT_SINGLE_FILE" // Default: "com.termux.RUN_COMMAND_RESULT_SINGLE_FILE"
                /** Intent {@code String} extra for the basename of the result file that should be created
                 * in {@link #EXTRA_RESULT_DIRECTORY} if {@link #EXTRA_RESULT_SINGLE_FILE} is {@code true}
                 * for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_RESULT_FILE_BASENAME = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_RESULT_FILE_BASENAME" // Default: "com.termux.RUN_COMMAND_RESULT_FILE_BASENAME"
                /** Intent {@code String} extra for the output {@link Formatter} format of the
                 * {@link #EXTRA_RESULT_FILE_BASENAME} result file for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_RESULT_FILE_OUTPUT_FORMAT = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_RESULT_FILE_OUTPUT_FORMAT" // Default: "com.termux.RUN_COMMAND_RESULT_FILE_OUTPUT_FORMAT"
                /** Intent {@code String} extra for the error {@link Formatter} format of the
                 * {@link #EXTRA_RESULT_FILE_BASENAME} result file for the RUN_COMMAND_SERVICE.ACTION_RUN_COMMAND intent */
                const val EXTRA_RESULT_FILE_ERROR_FORMAT = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_RESULT_FILE_ERROR_FORMAT" // Default: "com.termux.RUN_COMMAND_RESULT_FILE_ERROR_FORMAT"
                ...
                const val EXTRA_RESULT_FILES_SUFFIX = "$TERMUX_PACKAGE_NAME.RUN_COMMAND_RESULT_FILES_SUFFIX" // Default: "com.termux.RUN_COMMAND_RESULT_FILES_SUFFIX"
            }
        }
    }
    ...
    class TERMUX_API_APP {
        companion object {
            ...
            const val TERMUX_API_MAIN_ACTIVITY_NAME = "$TERMUX_API_PACKAGE_NAME.activities.TermuxAPIMainActivity" // Default: "com.termux.api.activities.TermuxAPIMainActivity"
            ...
            const val TERMUX_API_LAUNCHER_ACTIVITY_NAME = "$TERMUX_API_PACKAGE_NAME.activities.TermuxAPILauncherActivity" // Default: "com.termux.api.activities.TermuxAPILauncherActivity"
        }
    }
    ...
    class TERMUX_BOOT_APP {
        companion object {
            ...
            const val TERMUX_BOOT_MAIN_ACTIVITY_NAME = "$TERMUX_BOOT_PACKAGE_NAME.activities.TermuxBootMainActivity" // Default: "com.termux.boot.activities.TermuxBootMainActivity"
            ...
            const val TERMUX_BOOT_LAUNCHER_ACTIVITY_NAME = "$TERMUX_BOOT_PACKAGE_NAME.activities.TermuxBootLauncherActivity" // Default: "com.termux.boot.activities.TermuxBootLauncherActivity"
        }
    }
    ...
    class TERMUX_FLOAT_APP {
        companion object {
            ...
            const val TERMUX_FLOAT_ACTIVITY_NAME = "$TERMUX_FLOAT_PACKAGE_NAME.TermuxFloatActivity" // Default: "com.termux.window.TermuxFloatActivity"

            /** Termux:Float app core service name. */
            const val TERMUX_FLOAT_SERVICE_NAME = "$TERMUX_FLOAT_PACKAGE_NAME.TermuxFloatService" // Default: "com.termux.window.TermuxFloatService"
        }
        ...
        class TERMUX_FLOAT_SERVICE {
            companion object {
                ...
                const val ACTION_STOP_SERVICE = "$TERMUX_FLOAT_PACKAGE_NAME.ACTION_STOP_SERVICE" // Default: "com.termux.float.ACTION_STOP_SERVICE"

                /** Intent action to show float window. */
                const val ACTION_SHOW = "$TERMUX_FLOAT_PACKAGE_NAME.ACTION_SHOW" // Default: "com.termux.float.ACTION_SHOW"

                /** Intent action to hide float window. */
                const val ACTION_HIDE = "$TERMUX_FLOAT_PACKAGE_NAME.ACTION_HIDE" // Default: "com.termux.float.ACTION_HIDE"
            }
        }
    }
    ...
    class TERMUX_STYLING_APP {
        companion object {
            ...
            const val TERMUX_STYLING_ACTIVITY_NAME = "$TERMUX_STYLING_PACKAGE_NAME.TermuxStyleActivity" // Default: "com.termux.styling.TermuxStyleActivity"

            /** Termux:Styling app main activity name. */
            const val TERMUX_STYLING_MAIN_ACTIVITY_NAME = "$TERMUX_STYLING_PACKAGE_NAME.activities.TermuxStylingMainActivity" // Default: "com.termux.styling.activities.TermuxStylingMainActivity"
            ...
            const val TERMUX_STYLING_LAUNCHER_ACTIVITY_NAME = "$TERMUX_STYLING_PACKAGE_NAME.activities.TermuxStylingLauncherActivity" // Default: "com.termux.styling.activities.TermuxStylingLauncherActivity"
        }
    }
    ...
    class TERMUX_TASKER_APP {
        companion object {
            ...
            const val TERMUX_TASKER_MAIN_ACTIVITY_NAME = "$TERMUX_TASKER_PACKAGE_NAME.activities.TermuxTaskerMainActivity" // Default: "com.termux.tasker.activities.TermuxTaskerMainActivity"
            ...
            const val TERMUX_TASKER_LAUNCHER_ACTIVITY_NAME = "$TERMUX_TASKER_PACKAGE_NAME.activities.TermuxTaskerLauncherActivity" // Default: "com.termux.tasker.activities.TermuxTaskerLauncherActivity"
        }
    }
    ...
    class TERMUX_WIDGET_APP {
        companion object {
            ...
            const val TERMUX_WIDGET_MAIN_ACTIVITY_NAME = "$TERMUX_WIDGET_PACKAGE_NAME.activities.TermuxWidgetMainActivity" // Default: "com.termux.widget.activities.TermuxWidgetMainActivity"
            ...
            const val TERMUX_WIDGET_LAUNCHER_ACTIVITY_NAME = "$TERMUX_WIDGET_PACKAGE_NAME.activities.TermuxWidgetLauncherActivity" // Default: "com.termux.widget.activities.TermuxWidgetLauncherActivity"

            /**  Intent {@code String} extra for the token of the Termux:Widget app shortcuts. */
            const val EXTRA_TOKEN_NAME = "$TERMUX_PACKAGE_NAME.shortcut.token" // Default: "com.termux.shortcut.token"
        }
        ...
        class TERMUX_WIDGET_PROVIDER {
            companion object {
                ...
                const val ACTION_WIDGET_ITEM_CLICKED = "$TERMUX_WIDGET_PACKAGE_NAME.ACTION_WIDGET_ITEM_CLICKED" // Default: "com.termux.widget.ACTION_WIDGET_ITEM_CLICKED"

                /** Intent action to refresh files in the widget. */
                const val ACTION_REFRESH_WIDGET = "$TERMUX_WIDGET_PACKAGE_NAME.ACTION_REFRESH_WIDGET" // Default: "com.termux.widget.ACTION_REFRESH_WIDGET"

                /**  Intent {@code String} extra for the file clicked for the TERMUX_WIDGET_PROVIDER.ACTION_WIDGET_ITEM_CLICKED intent. */
                const val EXTRA_FILE_CLICKED = "$TERMUX_WIDGET_PACKAGE_NAME.EXTRA_FILE_CLICKED" // Default: "com.termux.widget.EXTRA_FILE_CLICKED"
            }
        }
    }
}
