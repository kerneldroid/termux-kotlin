...
public final class TerminalView extends View {
    ...
    public interface OnContextMenuShowListener {
        boolean onShowContextMenu(View view);
    }

    private OnContextMenuShowListener mOnContextMenuShowListener;

    public void setOnContextMenuShowListener(OnContextMenuShowListener listener) {
